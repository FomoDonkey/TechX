...
export const WEBHOOK_EVENT_LABELS: Record<WebhookEvent, string> = {
  ...
  "entry.review_requested": "Entrada enviada a revisión",
  "entry.approved": "Entrada aprobada",
  "entry.rescheduled": "Entrada reprogramada",
  "entry.assigned": "Asignación creada",
  "entry.unassigned": "Asignación eliminada",
