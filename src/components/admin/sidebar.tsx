...
const SECTIONS: Array<{
...
}> = [
  {
    ...
    items: [
      ...
      { href: "/admin/plantillas", label: "Plantillas", icon: Sparkles },
      ...
      { href: "/admin/ask", label: "Pregunta IA", icon: Sparkles },
      ...
      { href: "/admin/salud", label: "Salud", icon: Heart },
    ],
  },
  {
    label: "Crecer",
    items: [
      ...
      { href: "/admin/suscriptores", label: "Suscriptores", icon: Mailbox },
      { href: "/admin/segmentos", label: "Segmentos", icon: Filter },
      { href: "/admin/campanas", label: "Campañas", icon: Newspaper },
      { href: "/admin/membresias", label: "Membresías", icon: Crown },
      { href: "/admin/drips", label: "Drips", icon: GitBranch, soon: true },
